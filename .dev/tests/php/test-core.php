...
class Test_Core extends WP_UnitTestCase {
	...
	function testFontsUrl() {
		...
		$expected  = 'https://fonts.googleapis.com/css?family=Crimson Text:400,400i,700,700i|Nunito Sans:400,400i,600,700&subset=latin,latin-ext&display=swap';
	...
	function testAddDropdownIcons() {
		...
		$this->assertEquals( 'Title<svg aria-label="Title Menu" role="img" viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg"><path d="M1 1l4 4 4-4" stroke="currentColor" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="square" /></svg>', trim( $title ) );
