...
class Test_Core extends WP_UnitTestCase {
	...
	function testFontsUrl() {
		...
		$expected  = 'https://fonts.googleapis.com/css?family=Crimson Text:400,400i,700,700i|Nunito Sans:400,400i,600,700&subset=latin,latin-ext&font-display=swap';
