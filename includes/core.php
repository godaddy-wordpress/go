...
function get_available_header_variations() {
	$default_header_variations = array(
		'header-1' => array(
			...
			'preview_image' => get_theme_file_uri( 'src/images/customizer/header-1.svg' ),
		),
		'header-2' => array(
			'label'         => esc_html_x( 'Header 2', 'name of the second header variation option', 'go' ),
			'preview_image' => get_theme_file_uri( 'src/images/customizer/header-2.svg' ),
		),
		'header-3' => array(
			'label'         => esc_html_x( 'Header 3', 'name of the third header variation option', 'go' ),
			'preview_image' => get_theme_file_uri( 'src/images/customizer/header-3.svg' ),
		),
		'header-4' => array(
			'label'         => esc_html_x( 'Header 4', 'name of the fourth header variation option', 'go' ),
			'preview_image' => get_theme_file_uri( 'src/images/customizer/header-4.svg' ),
		),
	);
...
function get_available_footer_variations() {
	$default_footer_variations = array(
		'footer-1' => array(
			...
			'preview_image' => get_theme_file_uri( 'src/images/customizer/footer-1.svg' ),
			'partial'       => function() {
		...
		'footer-2' => array(
			...
			'preview_image' => get_theme_file_uri( 'src/images/customizer/footer-2.svg' ),
			'partial'       => function() {
		...
		'footer-3' => array(
			...
			'preview_image' => get_theme_file_uri( 'src/images/customizer/footer-3.svg' ),
			'partial'       => function() {
		...
		'footer-4' => array(
			...
			'preview_image' => get_theme_file_uri( 'src/images/customizer/footer-4.svg' ),
			'partial'       => function() {
