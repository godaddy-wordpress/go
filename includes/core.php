...
function get_available_header_variations() {
	$default_header_variations = [
		'header-1' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/header-1.svg',
			'partial'       => function() {
		...
		'header-2' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/header-2.svg',
			'partial'       => function() {
		...
		'header-3' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/header-3.svg',
			'partial'       => function() {
		...
		'header-4' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/header-4.svg',
			'partial'       => function() {
		...
		'header-5' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/header-5.svg',
			'partial'       => function() {
...
function get_available_footer_variations() {
	$default_footer_variations = [
		'footer-1' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/footer-1.svg',
			'partial'       => function() {
		...
		'footer-2' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/footer-2.svg',
			'partial'       => function() {
		...
		'footer-3' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/footer-3.svg',
			'partial'       => function() {
		...
		'footer-4' => [
			...
			'preview_image' => MAVERICK_TEMPLATE_URL . '/dist/images/footer-4.svg',
			'partial'       => function() {
