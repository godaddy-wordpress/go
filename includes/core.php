...
function get_available_design_styles() {
	...
	$default_design_styles = [
		'traditional' => [
			...
			'color_schemes' => [
				'one'   => [
					'label'      => _x( 'Apricot', 'color scheme name', 'go' ),
					'primary'    => '#c76919',
					'secondary'  => '#122538',
					'tertiary'   => '#f8f8f8',
					'background' => '#ffffff',
				...
				'two'   => [
					'label'      => _x( 'Emerald', 'color scheme name', 'go' ),
					'primary'    => '#165153',
					'secondary'  => '#212121',
					'tertiary'   => '#f3f1f0',
					'background' => '#ffffff',
				...
				'three' => [
					'label'      => _x( 'Brick', 'color scheme name', 'go' ),
					'primary'    => '#87200e',
					'secondary'  => '#242611',
					'tertiary'   => '#f9f2ef',
					'background' => '#ffffff',
				...
				'four'  => [
					'label'      => _x( 'Bronze', 'color scheme name', 'go' ),
					'primary'    => '#a88548',
					'secondary'  => '#05212d',
					'tertiary'   => '#f9f4ef',
					'background' => '#ffffff',
		...
		'modern'      => [
			...
			'color_schemes' => [
				'one'   => [
					'label'      => _x( 'Shade', 'color scheme name', 'go' ),
					'primary'    => '#000a12',
					'secondary'  => '#455a64',
					'tertiary'   => '#eceff1',
					'background' => '#ffffff',
				...
				'two'   => [
					'label'      => _x( 'Blush', 'color scheme name', 'go' ),
					'primary'    => '#c2185b', // 700
				...
				'three' => [
					'label'      => _x( 'Indigo', 'color scheme name', 'go' ),
					'primary'    => '#303f9f', // 700
				...
				'four'  => [
					'label'      => _x( 'Pacific', 'color scheme name', 'go' ),
					'primary'    => '#00796b', // 700
		...
		'trendy'      => [
			...
			'color_schemes' => [
				'one'   => [
					'label'             => _x( 'Plum', 'color scheme name', 'go' ),
					'primary'           => '#000000',
					'secondary'         => '#4d0859',
					'tertiary'          => '#ded9e2',
					'background'        => '#ffffff',
				...
				'two'   => [
					'label'             => _x( 'Steel', 'color scheme name', 'go' ),
					'primary'           => '#000000',
					'secondary'         => '#003c68',
					'tertiary'          => '#c0c9d0',
					'background'        => '#ffffff',
				...
				'three' => [
					'label'             => _x( 'Avocado', 'color scheme name', 'go' ),
					'primary'           => '#000000',
					'secondary'         => '#02493b',
					'tertiary'          => '#b4c6af',
					'background'        => '#ffffff',
				...
				'four'  => [
					'label'             => _x( 'Champagne', 'color scheme name', 'go' ),
					'primary'           => '#000000',
					'secondary'         => '#cc224f',
					'tertiary'          => '#e5dede',
					'background'        => '#ffffff',
		...
		'welcoming'   => [
			...
			'color_schemes' => [
				'one'   => [
					'label'             => _x( 'Forest', 'color scheme name', 'go' ),
					'primary'           => '#165144',
					'secondary'         => '#01332e',
					'tertiary'          => '#c9c9c9',
					'background'        => '#eeeeee',
				...
				'two'   => [
					'label'             => _x( 'Spruce', 'color scheme name', 'go' ),
					'primary'           => '#233a6b',
					'secondary'         => '#01133d',
					'tertiary'          => '#c9c9c9',
					'background'        => '#ffffff',
				...
				'three' => [
					'label'             => _x( 'Mocha', 'color scheme name', 'go' ),
					'primary'           => '#5b3f20',
					'secondary'         => '#3f2404',
					'tertiary'          => '#c9c9c9',
					'background'        => '#eeeeee',
				...
				'four'  => [
					'label'             => _x( 'Lavender', 'color scheme name', 'go' ),
					'primary'           => '#443a82',
					'secondary'         => '#2b226b',
					'tertiary'          => '#c9c9c9',
					'background'        => '#eeeeee',
		...
		'playful'     => [
			...
			'color_schemes' => [
				'one'   => [
					'label'             => _x( 'Frolic', 'color scheme name', 'go' ),
					'primary'           => '#3f46ae',
					'secondary'         => '#ecb43d',
					'tertiary'          => '#f7fbff',
					'background'        => '#ffffff',
				...
				'two'   => [
					'label'             => _x( 'Coral', 'color scheme name', 'go' ),
					'primary'           => '#e06b6d',
					'secondary'         => '#40896e',
					'tertiary'          => '#fff7f7',
					'background'        => '#ffffff',
				...
				'three' => [
					'label'             => _x( 'Organic', 'color scheme name', 'go' ),
					'primary'           => '#3c896d',
					'secondary'         => '#6b0369',
					'tertiary'          => '#f2f9f7',
					'background'        => '#ffffff',
				...
				'four'  => [
					'label'             => _x( 'Berry', 'color scheme name', 'go' ),
					'primary'           => '#117495',
					'secondary'         => '#d691c1',
					'tertiary'          => '#f7feff',
					'background'        => '#ffffff',
